...
public class UIDoctorMenu {
    ...
    public static ArrayList<Doctor> doctorAvailableAppointment = new ArrayList<Doctor>();
    ...
    public static void showDoctorMenu(){
        ...
        do {
            ...
            System.out.println("Welcome: "+ UIMenu.doctorLogger.getName());
    ...
    private static void showAddAvailableAppointmentMenu(){
        ...
        do {
            ...
            if (response > 0 && response < 4) {
                ...
                UIMenu.doctorLogger.addAvailableAppointment(date,time);
                checkDoctorAvailableAppointment(UIMenu.doctorLogger);
    ...
    private static void checkDoctorAvailableAppointment(Doctor doctor){
        ...
        && !doctorAvailableAppointment.contains((doctor))) {
